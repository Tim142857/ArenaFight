 ...
 */
class Quete extends \ArenaFightBundle\Entity\Quete implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ArenaFightBundle\\Entity\\Quete' . "\0" . 'id', '' . "\0" . 'ArenaFightBundle\\Entity\\Quete' . "\0" . 'nom', '' . "\0" . 'ArenaFightBundle\\Entity\\Quete' . "\0" . 'description', '' . "\0" . 'ArenaFightBundle\\Entity\\Quete' . "\0" . 'argent', '' . "\0" . 'ArenaFightBundle\\Entity\\Quete' . "\0" . 'pourcentageLoot', '' . "\0" . 'ArenaFightBundle\\Entity\\Quete' . "\0" . 'experience', '' . "\0" . 'ArenaFightBundle\\Entity\\Quete' . "\0" . 'duree', '' . "\0" . 'ArenaFightBundle\\Entity\\Quete' . "\0" . 'items'];
        }
    ...
    public function setPourcentageLoot($pourcentageLoot)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPourcentageLoot', [$pourcentageLoot]);

        return parent::setPourcentageLoot($pourcentageLoot);
    }
    ...
    public function getPourcentageLoot()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPourcentageLoot', []);

        return parent::getPourcentageLoot();
    }
